...
function displayNavBody()
{
    ...
    ul.innerHTML='<li class="navbar-item px-5"><a class="navbar-link text-decoration-none text-white item-center" href="#mainpage">الرئيسية</a></li>'+
            '<li class="navbar-item px-5"><a class="navbar-link text-decoration-none text-white item-center" href="#ourservices">خدمتنا</a></li>'+
            '<li class="navbar-item px-5"><a class="navbar-link text-decoration-none text-white item-center" href="#contactus">تواصل معنا</a></li>';
    return ul;
}
